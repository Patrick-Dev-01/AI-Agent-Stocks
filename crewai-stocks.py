...
newsAnalyst = Agent(
    ...
    with the news context. For each requested stock asset, specify a number between 0 and 100, where 0 is extreme fear and 100 extreme greed.
    """,
...
stockAnalystWrite = Agent(
    role="Senior Stock Analyst Write",
    ...
    and narratives resonate with wider audiences.
...
writeAnalyses = Task(
    description="""Use the stock price trend and the stock news report to create an analyses and write the newsletter about the {ticket} company
        that brief and highlights the most important points
        Focus on the stock price trend, news and fear/good score. What are the near future considerations?
        include the previous analyses of stock trend and news summary
    """,
    expected_output="""An eloquent 3 paragraphs newsletter formated as markdown in as easy readable manner. It should contain:
...
if submit_button:
    if not topic:
        ...
        st.subheader("results of your reasearch: ")
